...
function career(){
 ...
 <section class="card"><h2>版本</h2><div class="log"><strong>V1.9.2.2</strong>｜爆料防重複扣分、職業風評補償、改過自新、法律公關與扶養和解。</div></section>`;
}
function bind(){
...
function ensureMediaLaw(){const p=state.player;p.mediaLaw=p.mediaLaw||{cases:[],leaks:[],events:{},teamLevel:0,lastSourceSerial:{}};p.mediaLaw.events=p.mediaLaw.events||{};p.mediaLaw.lastSourceSerial=p.mediaLaw.lastSourceSerial||{};return p.mediaLaw}
