...
function career(){
 ...
 <section class="card"><h2>版本</h2><div class="log"><strong>V1.9.7.0</strong>｜成人派對一致性修正版：接受成人派對即代表自願參與成人性質活動；近期拒絕成人親密邀約者不會被派對繞過。每位成年女性獨立判定懷孕，因此同場可能多人懷孕；多人情境可記錄多名可能生父。</div></section>`;
}
function bind(){
